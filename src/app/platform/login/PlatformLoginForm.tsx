...
export function PlatformLoginForm({ redirectTo }: { redirectTo: string }) {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (data.ok) {
        // Open-Redirect-Schutz: nur interne Platform-Pfade zulassen.
        const safeTarget =
          redirectTo.startsWith("/platform") && !redirectTo.startsWith("//")
            ? redirectTo
            : "/platform";
