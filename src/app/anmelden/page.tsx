...
export default async function AnmeldenPage({ searchParams }: PageProps) {
  ...
  // Falls ref-Token vorhanden: bestehenden Contact suchen, Mail vorausfüllen
    ...
    return (
      <main className="grid min-h-screen place-items-center px-6">
        <div className="max-w-xl">
          ...
          <h1 className="text-display text-4xl leading-[1] md:text-5xl">Aktuell sind keine Tarife verfügbar.</h1>
    ...
    <main className="min-h-screen">
      <header className="border-b border-ink/15">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4 text-[11px] uppercase tracking-[0.14em]">
          <a href="/" className="font-mono">{STUDIO}</a>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 md:py-24">
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-ink-soft">
          Trag dich hier ein und wir bereiten alles für dich vor. Vertrag bekommst du in den nächsten Werktagen per Mail
          – nichts wird automatisch abgebucht.
        </p>
