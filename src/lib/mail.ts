...
//    Rechtlich sauber: enthält NUR die Bestätigungs-Anfrage,
//    keine Werbeinhalte und keine Preise.
// ─────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────
// 2) Willkommens-/Preis-Mail
//    Wird NACH erfolgreicher DOI-Bestätigung verschickt.
//    Enthält die aktuellen Tarife aus der DB und einen
//    "Hier anmelden"-Button mit ref-Token zur Conversion-Messung.
// ─────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────
// HTML-Templates (inline-styled für maximale Mail-Client-Kompatibilität)
// ─────────────────────────────────────────────────────────────
...
<body style="margin:0;padding:0;background:#F5F0E8;font-family:Georgia,serif;color:#1A1815;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#F5F0E8;padding:48px 16px;">
    <tr><td align="center">
      <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #D8D2C7;">
        <tr><td style="padding:40px;">
          ...
          <p style="font-size:13px;line-height:1.6;color:#8A857E;margin:32px 0 0;">Falls der Button nicht funktioniert, kopiere diesen Link in deinen Browser:<br><span style="word-break:break-all;color:#3A3530;">${confirmUrl}</span></p>
          <hr style="border:none;border-top:1px solid #D8D2C7;margin:32px 0;">
          <p style="font-size:12px;line-height:1.6;color:#8A857E;margin:0;">Wenn du dich nicht eingetragen hast, ignoriere diese Mail einfach – ohne Bestätigung passiert nichts.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
...
<body style="margin:0;padding:0;background:#F5F0E8;font-family:Georgia,serif;color:#1A1815;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#F5F0E8;padding:48px 16px;">
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #D8D2C7;">
        <tr><td style="padding:40px 40px 24px;">
          ...
          <p style="font-size:16px;line-height:1.6;margin:0;">Hier sind unsere aktuellen Tarife. Wenn dir einer zusagt, klick unten auf <em>Hier anmelden</em> – das geht in zwei Minuten.</p>
        </td></tr>
        ${planRows}
      ...
      <p style="font-family:'Courier New',monospace;font-size:11px;color:#8A857E;margin:24px 0 0;">${STUDIO_NAME} · <a href="${STUDIO_URL}/abmelden" style="color:#8A857E;">Abmelden</a></p>
    </td></tr>
  </table>
</body></html>`;
}
